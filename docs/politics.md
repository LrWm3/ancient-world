...
On a household head's death, an eligible present adult can take over the household's unchanged property share. Known children and members receive the existing succession preference; vacant estates remain when no representative or identity slot is available. This does not confer political leadership. See [leadership continuity](leadership-continuity.md) for explicit hereditary, governing-faction and household council selection rules. The political rule never changes the estate's owner, goods or account balance.
...
Each civilization now has nine available interests, including three pressure-dependent movements. Household allegiance can change, cohesion affects support, and the governing interest changes tax and autonomy preferences. See [expanded political interests](faction-interests.md) for the intentionally unstable bread leagues, revivalists and warbands, migration/archival behavior, and limits. A challenger still needs a five-percentage-point lead to replace the governing council faction. Dissent remains diagnostic; faction fragmentation does not create a civil war. Locally witnessed heritage recoveries provide bounded, decaying appeal for factions with participating members. A governing faction can retain control while replacing its ruler through the separate leadership policy.
...
Mobilization removes actual working adults, food and tools from the origin. Armies are capped by adult manpower and equipment, leave three months of civilian food behind, and carry provisions for outward travel, return travel and a margin. Tools currently serve as a generic equipment proxy. Armies eat monthly, suffer starvation without supplies, lose real manpower in combat, and lose equipment into the material ledger. New trade and relief departures across the opposing administrations stop during war; cargo already dispatched continues.

New campaigns have [shared person rosters](individual-participation.md#military-identity-bridge).
Recruitment also requires present, uncommitted adults and rounds resource limits
down to whole people. Named casualties, returns and bounded service experience
persist; older archived armies retain their aggregate behavior.

An unfortified objective resolves one aggregate battle. Completed defenses can first cause a [supply-limited land siege](supply-limited-sieges.md). Equipped manpower is compared with the defending adult levy; success transfers administration, while defeat preserves the defender's territory and prevents food looting. Remaining supplies and equipment return with survivors after an actual return journey. Both battle results end the war and start a ten-year truce. [Negotiated peace](negotiated-peace.md) can end an active campaign earlier with withdrawal and finite payment obligations. Victors can remain as a provisioned occupation force before withdrawal; they stay outside local population and leave when duration, supplies or political access require it. If another campaign changes the origin or target administrator before arrival, the army withdraws without fighting the new owner. Battles, peace and the expedition return retain causal event links.

This is territorial warfare at the campaign level, not tactical combat: no siege engines, reinforcement convoys, permanent standing garrisons, army interception, naval warfare, atrocities or multi-front diplomacy yet. A campaign may not conquer the outer continent. Dense farming, production and demography remain GPU simulations; family graphs, factions, claims and campaign records run on CPU.
