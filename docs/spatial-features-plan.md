...
| `politics::controllers`, `Claim.cell/sites`, factions, governance and offices | Controlled-site sets, claimed-cell regions, contested overlaps, jurisdiction associations | Claims already cover occupied cells, nearby hinterland and road corridors. Preserve holes/unclaimed interiors. Controller of a town is not proof of ownership of an entire inner continent. |
