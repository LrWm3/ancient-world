...
| Governance and institutions | Offices, mandates, upkeep and work-funded services | [Personal-duty audit completed](governance-duty-audit.md): office coordination has no named-time reservation, while upkeep has bounded cultural work but no institution-specific team; implement these distinct assignment gaps, then multi-site branches and multiple officers remain open |
