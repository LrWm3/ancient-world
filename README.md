...
Open **Civilizations beta** to experiment with histories on the inner continents.
New histories enable the standard systems by default; recent policy experiments
remain opt-in. Expand **Optional systems and experiments** before founding to
change them.
...
New headless histories use the same defaults. Override individual systems
