...
| [Financial statements](FINANCIAL-STATEMENTS.md) | Per-agent double-entry journal, trial balance, balance sheet, income, cash flows and equity changes; strict loan/mortgage/recovery and costed spot-trade adapters; opt-in material WIP, consumption and production losses; dated dues with native/coin payment; coin equipment purchases and use-based production cost | Paid labor/equipment manufacture and repair/cross-agent production costs, town markets/minting, forwards/estate-dues, households, FX and consolidation adapters |
